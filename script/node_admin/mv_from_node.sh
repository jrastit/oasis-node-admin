...
$REMOTE_CMD mkdir -p  $OASIS_NODE_DIR/node/data/tendermint
...
$REMOTE_CMD mv $SOURCE_NODE_DATA_DIR/tendermint/data $SOURCE_NODE_DATA_DIR/tendermint/abci-state $OASIS_NODE_DIR/node/data/tendermint 
