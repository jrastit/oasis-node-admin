...
$REMOTE_CMD_ADMIN mkdir $OASIS_NODE_DIR
$REMOTE_CMD_ADMIN chown $OASIS_NODE_SSH_NAME:$OASIS_NODE_SSH_NAME $OASIS_NODE_DIR
$REMOTE_CMD_ADMIN mkdir $OASIS_NODE_LOG_PATH
