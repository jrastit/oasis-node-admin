...
PARATIME_RUNTIME_IDENTIFIER="000000000000000000000000000000000000000000000000e199119c992377cb"
PARATIME_RUNTIME_VERSION="1.0.0"
...
PARATIME_RUNTIME_IAS="tnTwXvGbbxqlFoirBDj63xWtZHS20Lb3fCURv0YDtYw=@34.86.108.137:8650"
...
OASIS_NODE_ADDR="unix:$OASIS_NODE_DIR/node/data/internal.sock"
...
if [ -n "$CUSTOM_PARATIME_WORKER_P2P_PORT" ] ; then 
	PARATIME_PARATIME_WORKER_P2P_PORT=$CUSTOM_PARATIME_WORKER_P2P_PORT
fi
